            ...
            <section className='content-wrap'>
                <div className='page-content'>
                    <div className='container'>
                        ...
                        <p>
                            By downloading, installing, or using the App mobile application ("App"),
                        ...
                        <ul>
                            ...
                            <li>
                                Transmit or upload any harmful, offensive, or inappropriate content
                            </li>
                            <li>Attempt to gain unauthorized access to the App or its systems</li>
                            <li>
                                Interfere with or disrupt the App's functionality or booking system
                            </li>
                            <li>
                                Use automated scripts, bots, or other automated means to make
                                bookings
                            </li>
                        ...
                        <p>
                            ...
                            images, logos, and software, are owned by App and are protected by
                        ...
                        <p>
                            ...
                            the App for personal, non-commercial purposes in accordance with these
                            Terms.
                        </p>

                        <h3>5.3 User Content</h3>
                        <p>
                            If you submit any content to the App, you grant us a worldwide,
                        ...
                        <p>
                            ...
                            warranties, expressed or implied, regarding the App's functionality,
                        ...
                        <p>
                            ...
                            availability and bookings, we cannot guarantee the accuracy,
                            completeness, or timeliness of all data presented in the App.
                        </p>
                        ...
                        <p>
                            ...
                            arising out of or relating to your use of the App, including but not
                            limited to issues with bookings, payments, or club availability.
                        </p>

                        <h2>9. Indemnification</h2>
                        <p>
                            You agree to indemnify and hold harmless App from any claims, damages,
                            or expenses arising from your use of the App, your bookings, or
                        ...
                        <p>
                            We may release updates to the App from time to time. You agree to
                            install such updates to continue using the App.
                        </p>

                        <h3>10.2 Terms Updates</h3>
                        <p>
                            We reserve the right to modify these Terms at any time. We will notify
                            you of significant changes by posting the updated Terms in the App or on
                            our website.
                        </p>

                        <h2>11. Termination</h2>
                        <p>
                            These Terms remain in effect until terminated. We may terminate your
                        ...
                        <p>
                            These Terms constitute the entire agreement between you and App
                            regarding the use of the App and supersede all prior agreements and
                            understandings.
                        </p>
                        ...
                        <ul>
                            <li>
                                <strong>Email:</strong>{' '}
                                <a href='mailto:legal@app.com'>legal@app.com</a>
                            </li>
                            <li>
                        ...
                        <p>
                            <strong>
                                By using App, you acknowledge that you have read, understood, and
